  ...
  return (
    <div className='flex flex-col items-center  gap-1 bg-white drop-shadow-lg py-20 h-full'>
      <div className='flex flex-col gap-4 items-center mb-10'> 
        <div className='bg-[#F74B1B] h-28 w-28 text-white rounded-full text-center text-3xl font-bold pt-6'>B</div>
        <div className='text-2xl font-bold'>Organization Name</div>
      </div>
      <div className=' border-b-2 border-slate-300 px-5 py-5 text-center font-bold text-gray-500 w-full' onClick={()=>{
        setClick('Dashboard')
      }}>Dashboard</div>
      <div className=' border-b-2 border-slate-300 px-5 py-5 text-center font-bold text-gray-500 w-full' onClick={()=>{
        setClick('Blog')
